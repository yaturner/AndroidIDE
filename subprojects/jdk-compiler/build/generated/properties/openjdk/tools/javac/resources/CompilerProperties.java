...
public class CompilerProperties {
    public static class Errors {
         ...
         *    Annotation processor ''{0}'' does not implement jdkx.annotation.processing.Processor
         */
    ...
    public static class Notes {
         ...
         *    Multiple elements named ''{1}'' in modules ''{2}'' were found by jdkx.lang.model.util.Elements.{0}.
         */
